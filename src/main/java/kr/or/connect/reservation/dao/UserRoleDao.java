...
public class UserRoleDao {
	...
	private RowMapper<User.Role> userRoleRowMapper = BeanPropertyRowMapper.newInstance(User.Role.class);
	
	public UserRoleDao(DataSource dataSource) {
		this.jdbc = new NamedParameterJdbcTemplate(dataSource);
	}
	public List<User.Role> getUserRoleByEmail(String email) {
		Map<String, String> map = new HashMap<>();
		map.put("email", email);
		return jdbc.query(GET_ALL_BY_EMAIL, map, userRoleRowMapper);
	}
}
